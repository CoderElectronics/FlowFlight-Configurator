...
TABS.firmware_flasher = {
    releases: null,
    releaseChecker: new ReleaseChecker('firmware', 'https://api.github.com/repos/uptimefpv/FlowFlight/releases'),
        ...
        function process_hex(data, summary) {
            ...
            parse_hex(intel_hex, function (data) {
                ...
                if (parsed_hex) {
                    ...
                    var formattedNotes = summary.notes.replace(/#(\d+)/g, '[#$1](https://github.com/uptimefpv/FlowFlight/pull/$1)');
